...
from app.api.v1.endpoints import auth, users, residences, tasks, events, messages, dashboard
...
api_router.include_router(dashboard.router, tags=["Dashboard & Notifications"])
